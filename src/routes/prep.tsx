  ...
  return (
    <PhoneLayout>
      <div className="space-y-6 pt-2 pb-8">
        ...
        {!generated ? (
          <div className="rounded-3xl bg-white p-6 shadow-sm border border-border/50 space-y-5 text-center">
            ...
            <div className="space-y-2">
              <h2 className="font-serif text-xl">Generate your report</h2>
              <p className="text-sm leading-relaxed text-muted-foreground">
                Buddyguard will pull together your entries, patterns, and questions for your next{" "}
                {folder === "oncology" ? "Oncology" : "GP"} appointment.
              </p>
            </div>
            <button
              onClick={() => setGenerated(true)}
              className={cn(
                "w-full flex items-center justify-center gap-2 rounded-2xl py-3.5 text-sm font-medium transition-colors",
                folder === "oncology"
